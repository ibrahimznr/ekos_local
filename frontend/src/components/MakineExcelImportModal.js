...
const MakineExcelImportModal = ({ open, onClose, onSuccess }) => {
    ...
    const handleDownloadTemplate = async () => {
        try {
            const response = await axios.get(`${API}/makineler/excel/template`, {
                responseType: 'blob',
            });
            ...
            link.href = url;
            link.setAttribute('download', 'makine_sablonu.xlsx');
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${API}/makineler/excel/import`, formData, {
                headers: {
            ...
            <DialogContent className="max-w-2xl">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">
                        ...
                        Makine Excel İçe Aktarma
                    </DialogTitle>
                    <DialogDescription>
                        Excel dosyasından toplu makine içe aktarma
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-6 py-4">
                    ...
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                        ...
                        <Select value={selectedProje} onValueChange={setSelectedProje}>
                            <SelectTrigger className="w-full">
                                <SelectValue placeholder="Makineler hangi projeye eklensin?" />
                            </SelectTrigger>
                            <SelectContent>
                                {projeler.map((proje) => (
                    ...
                    <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-6">
                        <div className="text-center">
                            ...
                            <Button
                                onClick={() => document.getElementById('makine-excel-upload').click()}
                                variant="outline"
                            >
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-green-800">
                                            {result.imported_count} makine başarıyla içe aktarıldı
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        ...
                        <ul className="text-xs text-gray-700 space-y-1 list-disc list-inside">
                            <li>Makine Türü ve Firma alanları zorunludur</li>
                            <li>Tarih formatı: YYYY-MM-DD (2025-12-31)</li>
                            <li>Durum: Aktif veya Pasif olmalıdır</li>
...
export default MakineExcelImportModal;
